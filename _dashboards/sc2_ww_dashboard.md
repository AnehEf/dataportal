...
# More information
The Wisconsin State Laboratory of Hygiene [WSLH](https://slh.wisc.edu/) sequences about 20% of the samples that are tested for routine COVID-19 wastewater surveillance. Only samples with sufficient amounts of virus are sequenced. Large cities and university towns are emphasized in the wastewater genomic surveillance. However, sewersheds from rural communities are also sequenced to obtain a representative picture of COVID-19 variants circulating in Wisconsin.
